...
public class Command {
	...
	/** 
	 * Regular expression for error, unsuccessful response. 
	 * It can be set from JSON configuration file for Command-specific error indicator
	 * Else, It will be auto-generated by Commander using deviceSadRegex of Commander.
	 * Or, if none exist, it will stay null
	*/
